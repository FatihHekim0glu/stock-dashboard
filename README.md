...
<!-- TODO: docs/demo.gif, an 8 to 15 second screencap of the app in action.
...
Deployment to Hugging Face Spaces is in progress. In the meantime, see [Quickstart](#quickstart). It runs locally in under a minute.

## What this does

Single-ticker stock dashboard with five hand-rolled technical indicators (SMA, EMA, Bollinger Bands, RSI, MACD), plus volume bars rendered directly from the OHLCV frame, summary statistics for any date range, and synchronized hover across the price, volume and indicator subplots. All indicator math is hand-implemented in pandas/numpy and unit-tested against TA-Lib.
...
| Volume          | n/a          | Bars coloured by daily direction                              |
